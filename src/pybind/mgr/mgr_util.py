...
from ceph.fs.earmarking import CephFSVolumeEarmarking, \
    EarmarkException, EarmarkTopScope
...
class CephFSEarmarkResolver:
    ...
    def _manage_earmark(self, path: str, volume: str, earmark: Optional[str] = None) -> Optional[str]:
        """
    ...
    def check_earmark(self, earmark: str, top_level_scope: EarmarkTopScope) -> bool:
        ...
        return earmark.startswith(f"{top_level_scope.value}.")
